...
sky_surface = pygame.image.load('graphics/images.png').convert()
...
snail_rect = snail_surface.get_rect(bottomright=(600,500))


player_surf = pygame.image.load("graphics/player.png").convert_alpha()
player_rect= player_surf.get_rect(midbottom=(200,500))
player_gravity = 0
while True:
